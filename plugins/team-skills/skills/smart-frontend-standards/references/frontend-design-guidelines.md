...
若任务涉及动态主题色、`colorPrimary`、CSS 主题变量或 antd-mobile 主题同步，同时读取 `frontend-theme-color.md`。
...
- 使用主题色及其 hover、active、背景、边框派生色时，按 `frontend-theme-color.md` 选择 `colorPrimary*` token，不自行复制或推导主题色。
